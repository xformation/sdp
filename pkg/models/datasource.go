...
import (
	...
	"github.com/xformation/sdp/pkg/components/securejsondata"
...
var knownDatasourcePlugins map[string]bool = map[string]bool{
	...
	"newrelic-app":                        true,
	"sdp-datadog-datasource":          true,
	"sdp-simple-json":                 true,
	"sdp-splunk-datasource":           true,
	"udoprog-heroic-datasource":           true,
	"sdp-openfalcon-datasource":       true,
