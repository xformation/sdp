...
func setIndexViewData(c *middleware.Context) (*dtos.IndexViewData, error) {
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		SubTitle: "Services",
		Icon:     "fa fa-cog",
		Url:      setting.AppSubUrl + "/services",
	})
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		Url:      setting.AppSubUrl + "/subscription",
	})
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		SubTitle: "Resources",
		Icon:     "fa fa-users",
		Url:      setting.AppSubUrl + "/resources",
	})

	data.NavTree = append(data.NavTree, &dtos.NavLink{
		Text:     "Apps Center",
		Id:       "apps-center",
		SubTitle: "Apps Center",
		Icon:     "fa fa-th",
		Url:      setting.AppSubUrl + "/appscenter",
	})
	...
	// 		{Text: "Community site", Url: "http://community.sdp.com", Icon: "fa fa-fw fa-comment", Target: "_blank"},
	// 		{Text: "Documentation", Url: "http://docs.sdp.org", Icon: "fa fa-fw fa-file", Target: "_blank"},
	// 	},
	// })
