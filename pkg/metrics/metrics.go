...
func sendUsageStats() {
	...
	metricsLogger.Debug("Sending anonymous usage stats to stats.sdp.org")
	...
	go client.Post("https://stats.sdp.org/sdp-usage-report", "application/json", data)
}
