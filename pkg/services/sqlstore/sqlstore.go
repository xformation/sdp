...
import (
	...
	"github.com/xformation/sdp/pkg/services/sqlstore/migrations"
	"github.com/xformation/sdp/pkg/services/sqlstore/migrator"
	"github.com/xformation/sdp/pkg/services/sqlstore/sqlutil"
...
func LoadConfig() {
	...
	DbCfg.Path = sec.Key("path").MustString("data/sdp.db")
}
